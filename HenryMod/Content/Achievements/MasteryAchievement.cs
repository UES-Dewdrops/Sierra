...
namespace HenryMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => HenryPlugin.DEVELOPER_PREFIX + $"{Modules.StaticValues.characterBodyPrefix}MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => HenryPlugin.DEVELOPER_PREFIX + $"{Modules.StaticValues.characterBodyPrefix}UNLOCKABLE_REWARD_ID";
